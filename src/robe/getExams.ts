...
async function getExams(courseid:string, uni:string = 'unibs') {
    ...
    const path = `/Users/alessiogandelli/dev/studybuddy/uni-scraper/data/${uni}/courses/${courseid}.json`
...
async function main(){
    ...
    const courseids = jsonData.map((course: Course) => course.id)

    for (const courseid of courseids) {
        console.log('getting exams for', courseid);
...
//getExams('unibs54451', 'unibs')

getExams('unitn0419G', 'unitn')